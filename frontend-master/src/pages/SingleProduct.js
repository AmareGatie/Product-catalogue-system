...
const SingleProduct = () => {
  ...
  const addRatingProduct=()=>{
    if(star === null){
      ...
      toast.error("please Write riview about the product")
      return false
    }else{
      dispatch(addRating({star:star,comment:comment,prodId:getProdutId}))
      setTimeout(() => {
        dispatch(getAProduct(getProdutId))
      }, 3000);
    }
              ...
              <div className="review-form py-4">
                <h4>Write a Review</h4>
                  ...
                  <div className="d-flex justify-content-end">
                    <button className="button border-0"  onClick={addRatingProduct} type="button">Submit Review</button>
                  </div>
              </div>
              <div className="reviews mt-4">
                {
                  ...
                  <div className="d-flex gap-10 align-items-center">
                    <h6 className="mb-0">Amare Gatie</h6>
                    <ReactStars
                      count={5}
                      size={24}
                      value={item?.star}
