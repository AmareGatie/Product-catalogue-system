...
export const addToWislist = createAsyncThunk("product/wishlist",async(prodId, thunkAPI)=>{
    try{
...
export const productSlice= createSlice({
    ...
    extraReducers:(builder)=>{
        ...
        }).addCase(addToWislist.pending,(state)=>{
            state.isLoading=true;
        }).addCase(addToWislist.fulfilled,(state,action)=>{
            state.isLoading=false;
            state.isSuccess=true;
            state.isError=false;
    ...
    }).addCase(addToWislist.rejected,(state,action)=>{
        state.isLoading =false;
        state.isError=true;
        state.isSuccess=false;
        state.message=action.error;
    ...
    if(state.isSuccess){
        toast.success("Rating added Sucecefully")
    }
